...
bot = telebot.TeleBot('7536829181:AAGxf5xBoUom2oeg_mGHPUwMUH49ah9Eb4Q')
...
REQUIRED_CHANNELS = ["@+ySEL9NfxMS9mNzY1"]  # Add required channels here
...
def handle_attack(message):
    ...
    if not is_user_member(user_id):
        ...
        bot.reply_to(message, 
                   ...
                   f"➡️ [Join Channel 1](https://t.me/+ySEL9NfxMS9mNzY1)\n",  parse_mode="Markdown", disable_web_page_preview=True
                )
        return
